...
description: >-
  Guides Alipay Open Platform acquiring product selection and integration: in-person pay, order QR, H5 WAP, PC web, mini-program JSAPI, native app, pre-authorization freeze, and merchant periodic deduction.
  Use when the user discusses Alipay payment integration, routing, sandbox, RSA2 signing, or Chinese keywords such as 当面付、扫码、H5、订阅、自动续费、代扣、预授权.
  Not for WeChat Pay, UnionPay, transfers, reconciliation, red packets, or merchant profit sharing (分账).
